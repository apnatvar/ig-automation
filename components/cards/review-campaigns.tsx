...
}: // editHref = (id: string) => `/campaigns/${id}`, // navigate to detailed campaign card/page
{
  ...
  return (
    <section className="w-full min-w-0 mx-auto p-4 pt-0">
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="min-w-0 max-w-[100px] text-right">
                    Edit
                  </TableHead>
                  <TableHead className="min-w-0 max-w-[110px] text-right">
                    Run
                  </TableHead>
                  <TableHead className="min-w-0 max-w-[130px] text-right">
                    Delete
                  </TableHead>
                </TableRow>
              </TableHeader>
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                This cannot be recovered. Do you want to
                            ...
                            <AlertDialogFooter>
                              ...
                              <AlertDialogAction
                                onClick={() =>
                                  deletingId && confirmDelete(deletingId)
                                }
                              >
                                Yes, delete
                              </AlertDialogAction>
