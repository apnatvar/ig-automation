...
function makeMock(): ConnectedAccount[] {
  ...
  return Array.from({ length: 6 }, (_, i) => ({
    ...
    dateConnected: new Date(
      now - (i + 1) * 86400000 * (1 + Math.random() * 20)
    ),
          ...
          <ScrollArea className="w-full">
            ...
            <div className="min-w-[860px]">
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead className="min-w-0 max-w-[50px]">
                      Platform
                    </TableHead>
                    <TableHead className="min-w-0 max-w-[180px]">
                      Username
                    </TableHead>
                    <TableHead className="min-w-0 max-w-[150px]">
                      Date Connected
                    </TableHead>
                    <TableHead className="min-w-0 max-w-[60px]">
                      Active Campaigns
                    </TableHead>
                    <TableHead className="min-w-0 max-w-[120px] text-right">
                      Analytics
                    </TableHead>
                    <TableHead className="min-w-0 max-w-[150px] text-right">
                      Disconnect
                    </TableHead>
                  </TableRow>
                </TableHeader>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                ...
                                and stop all active sync. You can reconnect
                                later.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
